...
constexpr uint32_t _grid_color            = 0xC6C6C6;
constexpr uint32_t _grid_strong_color     = 0xA8A8A8;
...
constexpr std::array<SchulteView::Ring, 3> _layout_18 = {{
    {0.0f, 80.0f * _radius_scale, 4, -135.0f},
    {80.0f * _radius_scale, 150.0f * _radius_scale, 6, -120.0f},
    {150.0f * _radius_scale, static_cast<float>(_outer_radius), 8, -112.5f},
}};

constexpr std::array<SchulteView::Ring, 3> _layout_25 = {{
    {0.0f, 80.0f * _radius_scale, 6, -120.0f},
    {80.0f * _radius_scale, 150.0f * _radius_scale, 8, -112.5f},
    {150.0f * _radius_scale, static_cast<float>(_outer_radius), 11, -106.36f},
}};

constexpr std::array<SchulteView::Ring, 3> _layout_30 = {{
    {0.0f, 80.0f * _radius_scale, 6, -120.0f},
    {80.0f * _radius_scale, 150.0f * _radius_scale, 10, -108.0f},
    {150.0f * _radius_scale, static_cast<float>(_outer_radius), 14, -102.857142f},
}};
